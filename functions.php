...
class westYorkshire
{
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_script('time-app', THEME_DIR . '/js/jquery.timepicker.js', array('jquery'), '3.1.1P', false);
        wp_enqueue_script('jquery-cookie', THEME_DIR . '/js/jquery.cookie.js', array('jquery'), '3.1.1', false);
        wp_enqueue_script('viewport', THEME_DIR . '/js/jquery.viewportchecker.js', array('jquery'), '3.1.1', false);
